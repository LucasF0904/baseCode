const http = {
	/*
	 ...
	 | To have a server check the request's headers, a client must send Expect: 100-continue as a header in
	 | its initial request
	 | and receive a 100 Continue status code in response before sending the body. The response 417 Expectation
	...
	/*
	 ...
	 | In such case, there is no need to retransmit the resource since the client still has a previously-downloaded
	 | copy.
	 */
	NOT_MODIFIED: 304,
	...
	/*
	 ...
	 |--------------------------------------------------------------------------
	 | PROCESSINGThe client must first authenticate itself with the proxy.
	 */
	...
	/*
	 ...
	 | much data being encoded as a query-string of a GET request,
	...
	/*
	 ...
	 | teapots requested to brew coffee. This HTTP status is used as an Easter egg in some websites, including
	 | Google.com.
	 */
	I_AM_A_TEAPOT: 418,
